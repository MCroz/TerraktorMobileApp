    ...
    >
      <template v-slot:item="props">
        ...
        >
          <q-card>
            <q-card-section>
              {{ $Moment(props.row.Date).format("dddd, MMMM Do") }}
            </q-card-section>
            <q-separator />
            <q-list dense>
              <q-item>
                ...
                <q-item-section side>
                  <q-item-label caption> {{ props.row.IsLate == "1" ? 'Late' : 'On-Time' }} </q-item-label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                ...
                <q-item-section side>
                  <q-item-label caption> {{ $Moment(props.row.TimeIn,"LTS").format('LT') }} </q-item-label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                ...
                <q-item-section side>
                  <q-item-label caption> {{ $Moment(props.row.TimeOut,"LTS").format('LT') }} </q-item-label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label> Overtime (Mins) </q-item-label>
                </q-item-section>
                <q-item-section side>
                  <q-item-label caption> {{ props.row.Overtime }} </q-item-label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label> Overtime Approved? </q-item-label>
                </q-item-section>
                <q-item-section side>
                  <q-item-label caption> {{ props.row.OvertimeApproved == "1" ? 'Yes' : 'No' }} </q-item-label>
                </q-item-section>
              </q-item>
            </q-list>
          </q-card>
